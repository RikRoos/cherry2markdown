...
Also take a close look at the TOML configuration file and study the results it produces. Review the CLI parameters of the program (ch2md.py) Python runner as well, these can help a lot by analyzing the output.
