...
1. [Installation Instructions](#Installation%20Instructions)
	- [1. Create a working directory](#1.%20Create%20a%20working%20directory)
	- [2. Clone the repository](#2.%20Clone%20the%20repository)
	- [3. Create and activate a virtual environment](#3.%20Create%20and%20activate%20a%20virtual%20environment)
	- [4. Install the package](#4.%20Install%20the%20package)
	- [5. Verify installation](#5.%20Verify%20installation)
	- [6. Run the converter](#6.%20Run%20the%20converter)
1. [Some Design Choices](#Some%20Design%20Choices)
	- [How XML-tags and contents are handled](#How%20XML-tags%20and%20contents%20are%20handled)
	- [How `<rich_text>` attributes are handled](#How%20%60%3Crich_text%3E%60%20attributes%20are%20handled)
	- [How the filetree is generated](#How%20the%20filetree%20is%20generated)
	- [How lists are handled](#How%20lists%20are%20handled)
	- [How line-ends are handled](#How%20line-ends%20are%20handled)
	- [Log & Info](#Log%20&%20Info)
1. [Configuration](#Configuration)
	- [TOML configuration file](#TOML%20configuration%20file)
	- [Note on **note.title**](#Note%20on%20**note.title**)
	- [Command-line Arguments](#Command-line%20Arguments)
    	- [Positional Arguments:](#Positional%20Arguments)
    	- [Additional Options:](#Additional%20Options)
